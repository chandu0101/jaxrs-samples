    ...
    public static Class forName(String fqcn) throws RuntimeException {
       ...
       /*     if (log.isTraceEnabled()) {
        ...
        if (clazz == null) {
                ...
                /*log.info("Unable to load class named [" + fqcn + "] from the current ClassLoader.  " +
    ...
    private static abstract class ExceptionIgnoringAccessor implements ClassLoaderAccessor {
        ...
        public Class loadClass(String fqcn) {
            ...
            if (cl != null) {
                try {
                    ...
                    // log.info("Unable to load clazz named [" + fqcn + "] from class loader [" + cl + "]");
                }
            }
            return clazz;
        }
        ...
        protected final ClassLoader getClassLoader() {
            try {
                ...
                //log.info("Unable to acquire ClassLoader.");
            }
            return null;
        }
